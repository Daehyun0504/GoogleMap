...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener, GoogleMap.OnMapClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_xy = findViewById(R.id.button_xy);
                ...
                switch (view.getId()){
                    case R.id.button_list:
                        if(map.getVisibility()==View.VISIBLE){
                            ...
                            button_test.setVisibility(View.GONE);
                            button_list.setImageResource(R.drawable.list);
                        }


                        if(button_test.getVisibility() == View.VISIBLE) button_list.setColorFilter(null);

                        break;
                    case R.id.button_xy:
                        button_xy.setColorFilter(Color.parseColor("#55ff0000"));
                        break;
                    case R.id.button_my:
        ...
        button_xy.setOnClickListener(clickListener);
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        a[0] = new LatLng(37.56214048107756, 126.99193148544094);
        ...
        cus_company[0][2] = true;
            ...
            for(j=0 ; j<=2 ; j++){
                ...
                markerOptions.position(seoul).title(title[j]).snippet("스마트폰 케이스 공방입니다")
    ...
    public boolean onMarkerClick(@NonNull Marker marker) {
        ...
        tri = next.equals("Case");
        Toast.makeText(getApplicationContext(), "지도 짧게 클릭하면 들어가기 사라짐요", Toast.LENGTH_SHORT).show();
        return false;
    }
